                    ...
                    <div class="card card-widget widget-user-2">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-sm-6 border-left">
                                    <div class="description-block">
                                        ...
                                        <a target="_blank" href="https://<?= $data['domain'] ?>.nginvite.com">
                                            <h5 class="text-sm description-header">https://<?= $data['domain'] ?>.nginvite.com</h5>
                                        </a>
                                    </div>
                                    <!-- /.description-block -->
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <a target="_blank" href="<?= base_url() . $data['domain']  ?>" class="btn btn-sm btn-block btn-primary">
                                        Lihat
                                    </a>
                                </div>
                            </div>
