$(function () {
    ...
    ImagesGrid.prototype.renderGridItems = function () {
        ...
        for (var i = 0; i < imgsLen; ++i) {
            ...
            this.renderGridItem(imgs[i], txts[i], fname[i], i);
        }
    ...
    ImagesGrid.prototype.renderGridItem = function (image, text, fileName, index) {
        ...
        item.append(
            $('<div>', {
                ...
                $('<b>', {
                    class: 'desc-text',
                    text: opts.getDescText(text)
                }),
                $('<br>'),
                $('<span>', {
                    class: 'desc-text-name',
                    text: opts.getNameText(fileName)
                })
            )
        )
