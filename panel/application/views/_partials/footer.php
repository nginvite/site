...
<footer class="main-footer ">
    <!-- Default to the left -->
    <strong>Copyright &copy; <?= date('Y', time()) ?> <a href="<?= base_url() ?>"><?= app_name() ?></a>.</strong> All rights reserved.
</footer>
</div>
...
<script src="<?= base_url('assets-'.app_version().'/') ?>plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
...
<script src="<?= base_url('assets-'.app_version().'/') ?>dist/js/bootstrap-iconpicker.bundle.min.js"></script>
...
<script src="<?= base_url('assets-'.app_version().'/') ?>plugins/datatables/dataTables.bootstrap4.js" type="module"></script>
<script src="<?= base_url('assets-'.app_version().'/') ?>plugins/datatables/dataTables.checkboxes.min.js" type="module"></script>
<script src="<?= base_url('assets-'.app_version().'/') ?>plugins/datatables/extensions/Mark/mark.min.js"></script>
<script src="<?= base_url('assets-'.app_version().'/') ?>plugins/datatables/extensions/Mark/datatables.mark.js"></script>
<script src="<?= base_url('assets-'.app_version().'/') ?>plugins/datatables/extensions/FixedColumns/js/dataTables.fixedColumns.js"></script>
<script src="<?= base_url('assets-'.app_version().'/') ?>plugins/datatables/extensions/FixedColumns/js/fixedColumns.bootstrap4.js"></script>
<script src="<?= base_url('assets-'.app_version().'/') ?>plugins/datatables/extensions/FixedColumns/js/fixedColumns.bootstrap4.js"></script>
...
<script src="<?= base_url('assets-'.app_version().'/') ?>plugins/lottie/lottie-player.js"></script>
</body>
</html>
