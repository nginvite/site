import {BASE_URL} from "../../../dist/js/main.js";
...
(function (factory) {
    ...
    CropAvatar.prototype = {
        ...
        submitDone: function (data) {
            if ($.isPlainObject(data) && data.state === 200) {
                if (data.result) {
                    ...
                    $.ajax({
                        url: BASE_URL + "cl_menu/uploadCropImg",
                        type: 'post',
                        data: {data_sid: data.data_sid, base64: data.result, data_desc: data.data_desc, path: data.urlPath, thumb: data.thumb},
                        dataType: 'json',
                        beforeSend: function () {
                        },
                        complete: function () {
                    ...
                    //jQuery('img#render-avatar').attr('src', 'data:image/jpeg;base64,' + data.result);
        ...
        alert: function (msg) {
            var $alert = [
                '<div class="alert alert-danger avatar-alert alert-dismissable col-12">',
